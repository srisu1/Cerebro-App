...
class _DailyTabState extends ConsumerState<DailyTab>
  ...
  void _toggleMorning(int i) {
    setState(() => _morningDone[i] = !_morningDone[i]);
    _saveMorning();
  }

  void _toggleEvening(int i) {
    setState(() => _eveningDone[i] = !_eveningDone[i]);
    _saveEvening();
  }
  ...
  //  HERO TOP — back button + page title (matches Health Hub)
  Widget _buildHeroTop() {
    return Row(children: [
      ...
      const Text(
        'Daily',
        style: TextStyle(fontFamily: 'Bitroad', fontSize: 26, color: _brown),
      ),
    ]);
  }

  //  HERO — "My Day" banner + motivation + score ring
  Widget _buildHero(int score, Color scoreColor) {
    return Row(
      ...
      children: [
        ...
        _ScoreRing(score: score, color: scoreColor, size: 98),
      ],
    );
  }
              ...
              children: iconKeys.map((k) {
                ...
                return GestureDetector(
                  ...
                  child: AnimatedContainer(
                    ...
                    height: 38,
                    decoration: BoxDecoration(
                      color: active ? _olive.withOpacity(0.85) : _cream,
                      borderRadius: BorderRadius.circular(10),
                      border: Border.all(
                        color: active
                            ? _oliveDk
